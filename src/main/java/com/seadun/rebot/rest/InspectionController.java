...
public class InspectionController {
	...
	public ResponseEntity<ResponseSuccessResult> page(@RequestParam(required = true) int pageNo,
			@RequestParam(required = true) int pageSize,String computerId,String contractStatus,String contractDetailStatus) {
		...
		List<ContractComputer> contractComputerList = contractComputerMapper.selectPage(rowBounds, computerId, contractStatus, contractDetailStatus);
